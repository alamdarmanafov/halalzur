...
//
// Auth: same "x-app-key must match the public Supabase anon key" pattern
// as send-broadcast.js and check-certifier-links.js — the admin panel has
// no server-verified session (see send-broadcast.js's header comment for
// the accepted-risk rationale). This intentionally does NOT reuse
