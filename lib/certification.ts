...
const MOCK_DB: Record<string, CertificationResult> = {
  ...
  '4006381333931': {
    ...
    verifiedAt: null,
    ingredients: ['Şəkər', 'Qlükoza siropu', 'Jelatin (mənbəyi qeyri-müəyyən)'],
    notes: 'Tərkibdə mənşəyi təsdiqlənməmiş jelatin var — donuz mənşəli ola bilər.',
    imageEmoji: '🍬',
  },
  '5449000000996': {
    ...
    certificateNumber: null,
    verifiedAt: null,
    ingredients: ['Su', 'Şəkər', 'CO2', 'Aromatizatorlar (E-kodları qeyri-müəyyən)'],
