...
export const ECODE_STATUS_LABEL: Record<ECodeStatus, string> = {
  halal: "Halal",
...
export function findECode(code: string): ECodeEntry | undefined {
  // Case-insensitive: some codes carry a lowercase suffix letter (E150a,
  // E160b), so a plain toUpperCase() compare would miss them.
  const normalized = code.trim().toLowerCase();
  return E_CODES.find((e) => e.code.toLowerCase() === normalized);
}

export function slugForECode(code: string): string {
