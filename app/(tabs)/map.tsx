...
import { View, Text, StyleSheet, FlatList, Pressable, ScrollView, ActivityIndicator, Linking } from 'react-native';
...
export default function MapScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <Text style={styles.subtitle}>Bir məkana toxunub Google Maps-də yol tərifi al</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable style={styles.card} onPress={() => openInGoogleMaps(item)}>
            ...
            <Ionicons name="open-outline" size={20} color={colors.grayLight} />
          </Pressable>
        )}
      />
    </SafeAreaView>
